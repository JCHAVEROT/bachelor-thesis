...
\input{chapters/02_gen6d_formal_description}
\input{chapters/03_implementation_of_the_model}
\input{chapters/04_presentation_of_the_results}
\input{chapters/05_ways_of_improvements}
...
\input{appendix/A_python_scripts}
\input{appendix/B_scitas_izar_setup_tutorial}
\microtypesetup{protrusion=true}
