...
\input{chapters/02_scientific_papers_review}
\input{chapters/03_gen6d_formal_description}
\input{chapters/04_implementation_of_the_model}
\input{chapters/05_presentation_of_the_results}
\input{chapters/06_ways_of_improvements}
