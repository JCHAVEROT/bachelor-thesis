...
\newcommand*{\getTitle}{CVLab Unseen Spacecraft Pose Estimation}
\newcommand*{\getTitleGer}{Baseline implementation of a generalizable 6DoF object pose estimator}
\newcommand*{\getAuthor}{Jérémy Chaverot}
\newcommand*{\getDoctype}{Bachelor's Thesis}
\newcommand*{\getSupervisor}{Dr. Mathieu Salzmann}
\newcommand*{\getAdvisor}{Andrew Price, Chen Zhao}
\newcommand*{\getSubmissionDate}{05.01.2024}
